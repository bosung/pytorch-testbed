...
if __name__=="__main__":
    ...
    decoder = AttentionDecoder(vocab.n_words, 64, 64, batch_size).to(device)
    ...
    max_a_at_5, max_a_at_1 = ev.evaluate(encoder, vocab, batch_size)
    ...
    for epoch in range(1, total_epoch+1):
        ...
        trainIters(epoch, encoder, decoder, total_epoch, train_data, vocab, train_loader, print_every=1, learning_rate=0.1)
        ...
        if epoch % 20 == 0:
            ...
            if a_at_5 > max_a_at_5:
                max_a_at_5 = a_at_5
                print("New record! accuracy@1: %.4f" % a_at_5)
